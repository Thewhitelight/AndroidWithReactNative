...
import {AppRegistry, View, Navigator, NativeModules, ToastAndroid, BackAndroid} from "react-native";
...
export default class Libery extends Component {
    ...
    componentDidMount() {
        NativeModules.IntentModule.dataToJS((msg) => {
            console.log("msg" + msg);
            if (msg == "ReactNativeActivity") {
                console.log("1:" + msg);
                this.setState({defaultComponent: Item1});
            }
            if (msg == "ReactViewActivity") {
                console.log("2:" + msg);
                this.setState({defaultComponent: Item2});
            }
